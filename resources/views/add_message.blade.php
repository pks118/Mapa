    ...
    <form action="/addmessage "method="post" >
        ...
        @csrf
            <div class="mb-3">
                ...
                <input type="text" name="gor" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Город" value="{{old('gor')}}">
                <span style="color: red;">@error('gor'){{$message}} @enderror</span>
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Координаты</label>
                <input type="text" name="koordinat" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Координаты" value="{{old('koordinat')}}">
                <span style="color: red;">@error('koordinat'){{$message}} @enderror</span>
